...
// class Api {
//     static getAllBrands() {
//         return new Promise((resolve, reject) => setTimeout(() => resolve(brands)), 1200);
//     }
//
//     static searchBrandByName(qs) {
//         return new Promise((resolve, reject) => {
//             let result = brands.filter(brand => {
//                 const fullName = `${brand.name.first.toLowerCase()} ${brand.name.last.toLowerCase()}`;
...
class Api {
    static getAllBrands() {
        return new Promise((resolve, reject) => setTimeout(() => resolve('https://brands-fb.herokuapp.com/api')), 1200);
    }
    ...
    static searchBrandByName(qs) {
        return new Promise((resolve, reject) => {
            let result = brands.filter(brand => {
                ...
                return brandName.indexOf(qs.toLowerCase()) > -1;
            });
...
// class Api {
//   getAllBrands() {
//     let url = 'https://brands-fb.herokuapp.com/api';
